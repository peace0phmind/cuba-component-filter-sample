...
public class TestTestContainer extends TestContainer {

    public TestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/test/app.properties",
    ...
    public static class Common extends TestTestContainer {

        public static final TestTestContainer.Common INSTANCE = new TestTestContainer.Common();
